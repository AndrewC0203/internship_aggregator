...
After I decide:
6. Ask me to justify the choice in my own words before proceeding. "Which
   tradeoffs are you accepting, and why are they acceptable here?"
7. If my justification is weak or the choice has a flaw I haven't addressed,
   ...
   if I'm stuck. Don't just tell me the answer.
8. If my choice is defensible, say so and move on — don't manufacture
   objections to seem rigorous. A justified "good enough" choice is correct.
9. I make the final call either way, including choices you disagree with.
   Log your objection in the DECISIONS.md entry if you have one, then build it.
10. Prompt me to log the decision in DECISIONS.md (format below) before we build.
